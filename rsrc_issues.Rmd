...
Here we describe how to find and consider working on open issues in rOpenSci projects. In 2019, 117 people made their first-ever code contribution to rOpenSci! The [rOpenSci issues list](https://github.com/search?q=org%3Aropensci+state%3Aopen&type=Issues) is a dynamic page showing all open issues in the “rOpenSci GitHub organization”. 
...
Are you a package author who wants to encourage people to help with issues in your project? Consider making your packages “[contribution and collaboration friendly](https://devguide.ropensci.org/collaboration.html#friendlyfiles)” by including a [code of conduct](https://devguide.ropensci.org/collaboration.html#code-of-conduct), a contribution guide, and by labelling issues as suggested above. Some good examples of contribution guides are [this one](https://gist.github.com/peterdesmet/e90a1b0dc17af6c12daf6e8b2f044e7c) from [Peter Desmet](https://ropensci.org/author/peter-desmet/), and [this one](https://github.com/ecohealthalliance/fasterize/blob/master/CONTRIBUTING.md) from [Noam Ross](https://ropensci.org/author/noam-ross/).
