...
*   **Explore use cases** in [our public forum UseCases category](https://discuss.ropensci.org/c/usecases/10). Comment on or [emoji heart] use cases that you find useful or inspiring. Consider tweeting or sharing to other social media platforms too if you find them particularly helpful.
...
![alt_text](images/usecases-template-shadow.png "image_tooltip")

_Use case template_

_Screenshot a cool use case_
