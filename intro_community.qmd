...
contribute to, or maintain a package, being champions, mentor or trainer for our Champions Program, localize our material, or participate in rOpenSci peer review as a reviewer, 
author or editor.
...
We recognize that communities are not inclusive by default, particularly as they grow: they require deliberate attention. We are carrying out a Champions Program and a Localization project to ensure our research software serves everyone in our communities. 
...
```{r}
#| results: asis
team <- jsonlite::read_json("https://raw.githubusercontent.com/ropensci/roweb3/main/data/team/team.json")
...
cat(paste(c(
  glue::glue_collapse(purrr::map_chr(staff, format_one), sep = ", ", last = " and "),
  ".",
  collapse = ""
  ))
)
...
cat(paste(c(
  glue::glue_collapse(purrr::map_chr(past_staff, format_one), sep = ", ", last = " and  ")),
  "are Staff alumni."
))
```
...
cat(paste(c(
  glue::glue_collapse(purrr::map_chr(advisors, format_one), sep = ", ", last = " and ")),
...
cat(paste(c(
  glue::glue_collapse(purrr::map_chr(editors, format_one), sep = ", ", last = " and  ")),
  "volunteer their time."
))
```
...
cat(paste(c(
  glue::glue_collapse(purrr::map_chr(past_editors, format_one), sep = ", ", last = " and ")),
  "are Editor alumni."
))
```
...
[![Headshots of the rOpensci team](webshot.png "Headshots of the rOpensci team")](https://ropensci.org/about/#team)
