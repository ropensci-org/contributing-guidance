...
Making data, tools, and best practices more discoverable is part of [our mission](#mission). For many, using an rOpenSci package is their first encounter with our organization. It’s the most common gateway to further involvement through connections with other users, or sharing use cases, for example. 
...
*   [Read blog posts or tech notes](#blog) about specific rOpenSci packages, about [creative use cases](./resources.html#blog-usecases) for multiple rOpenSci packages, or about [open data accessible through our packages](./resources.html#blog-opendata)
...
*   [Follow roknowtifier on Twitter](#channels) to get notified about new packages and package updates in real time
...
*   [Read blog posts or tech notes](#blog), particularly those tagged with [“welcome”](./resources.html#blog-welcome), [“unconf”](./resources.html#blog-unconf), or [“icebreaker”](./resources.html#blog-icebreaker)
